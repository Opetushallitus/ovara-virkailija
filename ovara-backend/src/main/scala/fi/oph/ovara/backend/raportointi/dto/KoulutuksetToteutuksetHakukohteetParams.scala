...
def buildKoulutuksetToteutuksetHakukohteetAuditParams(
  valid: ValidatedKoulutuksetToteutuksetHakukohteetParams
): Map[String, Any] = {
  Map(
...
def buildKoulutuksetToteutuksetHakukohteetParamsForExcel(
  params: ValidatedKoulutuksetToteutuksetHakukohteetParams,
